...
def train_gbm(train_file, test_file, model_file):
    train_files = [train_file+".1.1", train_file+".1.2", train_file+".1.3", train_file+".1.4",
                   train_file+".2.1", train_file+".2.2", train_file+".2.3", train_file+".2.4",
                   train_file+".3.1", train_file+".3.2", train_file+".3.3", train_file+".3.4"]
