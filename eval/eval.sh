...
python -u eval_candi.py --input_file /data/users/jianbogu/amazon/cand/candi_100_top100.pre.csv \
  --log_file ${root}/log/eval_candi2.log

nohup python -u eval_rank_mrr.py --input_file ${root}/cand/candi_feat_100.test.pred \
